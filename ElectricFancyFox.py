...
# updated by plpla (Pier-Luc Plante)
# 2012-10-17
...
This program was upgraded because of a system upgrade.
...
for dual indexes before update:
...
for dual indexes after Illumina(R) MiSeq(R) upgrade:
